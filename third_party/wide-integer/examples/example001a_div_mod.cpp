...
bool math::wide_integer::example001a_div_mod() {
    ...
    WIDE_INTEGER_CONSTEXPR uint512_t a("6989373397903475430537974005643661187443125371384456079195486281758221158058129"
                                       "83955794321304304417541511379093392776018867245622409026835324102460829431");
    WIDE_INTEGER_CONSTEXPR uint512_t b(
    ...
    WIDE_INTEGER_CONSTEXPR bool result_is_ok =
        ((c == "6986485091668619828842978360442127600954041171641881730123945989288792389271") &&
