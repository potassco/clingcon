...
namespace {
template <typename LimbType, typename AllocatorType = void> bool generate() {
    using random_engine_type =
        std::mersenne_twister_engine<std::uint64_t, 64, 312, 156, 31, UINT64_C(0xB5026F5AA96619E9), 29,
                                     UINT64_C(0x5555555555555555), 17, UINT64_C(0x71D67FFFEDA60000), 37,
                                     UINT64_C(0xFFF7EEE000000000), 43, UINT64_C(6364136223846793005)>;
...
bool math::wide_integer::example007_random_generator() {
    ...
    const bool result_is_ok = (result_08_is_ok && result_16_is_ok && result_32_is_ok);
