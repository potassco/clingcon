...
namespace Catch {
    namespace Matchers {
        ...
        //! Creates a matcher that accepts numbers within certain range of
        //! target
        ...
        //! Creates a matcher that accepts doubles within certain ULP range of
        //! target
        WithinUlpsMatcher WithinULP( double target, uint64_t maxUlpDiff );
        //! Creates a matcher that accepts floats within certain ULP range of
        //! target
        ...
        //! Creates a matcher that accepts doubles within certain relative range
        //! of target
        WithinRelMatcher WithinRel( double target, double eps );
        //! Creates a matcher that accepts doubles within 100*DBL_EPS relative
        //! range of target
        WithinRelMatcher WithinRel( double target );
        //! Creates a matcher that accepts doubles within certain relative range
        //! of target
        WithinRelMatcher WithinRel( float target, float eps );
        //! Creates a matcher that accepts floats within 100*FLT_EPS relative
        //! range of target
