    ...
    namespace Matchers {
        ...
        public:
            ...
            bool match( RangeLike&& rng ) const {
                for ( auto&& elem : rng ) {
                    if ( !m_matcher.match( elem ) ) { return false; }
                }
                return true;
            }
        };

        // Matcher for checking that no element in range matches a given
        // matcher.
        template <typename Matcher>
        ...
        // Matcher for checking that at least one element in range matches a
        // given matcher.
        template <typename Matcher>
        ...
        public:
            ...
            bool match( RangeLike&& rng ) const {
                for ( auto&& elem : rng ) {
                    if ( m_matcher.match( elem ) ) { return true; }
                }
                return false;
            }
        };
        ...
        // Creates a matcher that checks whether all elements in a range match a
        // matcher
        template <typename Matcher>
        ...
        // Creates a matcher that checks whether any element in a range matches
        // a matcher.
        template <typename Matcher>
        ...
        // Creates a matcher that checks whether all elements in a range are
        // true
