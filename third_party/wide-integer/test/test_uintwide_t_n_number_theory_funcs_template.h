...
template <const math::wide_integer::size_t MyWidth2, typename MyLimbType = std::uint32_t>
class test_uintwide_t_n_number_theory_funcs_template : public test_uintwide_t_n_base {
  public:
    ...
    test_uintwide_t_n_number_theory_funcs_template(const std::size_t count) : test_uintwide_t_n_base(count) {}
...
#endif // TEST_UINTWIDE_T_N_NUMBER_THEORY_FUNCS_TEMPLATE_2019_12_29_H_  #include
       // <test/test_uintwide_t_n_binary_ops_base.h>
