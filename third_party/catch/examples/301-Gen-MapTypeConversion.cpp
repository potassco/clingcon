...
namespace {
    ...
    // Notice that it returns an instance of GeneratorWrapper<std::string>,
    // which is a value-wrapper around std::unique_ptr<IGenerator<std::string>>.
