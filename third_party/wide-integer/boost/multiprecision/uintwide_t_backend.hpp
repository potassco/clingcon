...
template <const ::math::wide_integer::size_t MyWidth2, typename MyLimbType> class uintwide_t_backend;
...
template <const ::math::wide_integer::size_t MyWidth2, typename MyLimbType>
struct number_category<uintwide_t_backend<MyWidth2, MyLimbType>> : public boost::mpl::int_<number_kind_integer> {};
...
template <const ::math::wide_integer::size_t MyWidth2, typename MyLimbType = std::uint32_t> class uintwide_t_backend {
  public:
...
#else
    using signed_types =
        std::tuple<signed char, signed short, signed int, signed long, signed long long, std::intmax_t>;
    using unsigned_types =
        std::tuple<unsigned char, unsigned short, unsigned int, unsigned long, unsigned long long, std::uintmax_t>;
    ...
    WIDE_INTEGER_CONSTEXPR uintwide_t_backend &operator=(const std::string &str_rep) {
        m_value = representation_type(str_rep);
        return *this;
    }
    WIDE_INTEGER_CONSTEXPR uintwide_t_backend &operator=(const char *char_ptr) {
        m_value = representation_type(char_ptr);
        return *this;
    }
    ...
    WIDE_INTEGER_CONSTEXPR void negate() { m_value.negate(); }
...
template <const ::math::wide_integer::size_t MyWidth2, typename MyLimbType>
WIDE_INTEGER_CONSTEXPR void eval_add(uintwide_t_backend<MyWidth2, MyLimbType> &result,
                                     const uintwide_t_backend<MyWidth2, MyLimbType> &x) {
    result.representation() += x.crepresentation();
}

template <const ::math::wide_integer::size_t MyWidth2, typename MyLimbType>
WIDE_INTEGER_CONSTEXPR void eval_subtract(uintwide_t_backend<MyWidth2, MyLimbType> &result,
                                          const uintwide_t_backend<MyWidth2, MyLimbType> &x) {
    result.representation() -= x.crepresentation();
}

template <const ::math::wide_integer::size_t MyWidth2, typename MyLimbType>
WIDE_INTEGER_CONSTEXPR void eval_multiply(uintwide_t_backend<MyWidth2, MyLimbType> &result,
                                          const uintwide_t_backend<MyWidth2, MyLimbType> &x) {
    result.representation() *= x.crepresentation();
}

template <const ::math::wide_integer::size_t MyWidth2, typename MyLimbType, typename IntegralType,
...
template <const ::math::wide_integer::size_t MyWidth2, typename MyLimbType>
WIDE_INTEGER_CONSTEXPR void eval_divide(uintwide_t_backend<MyWidth2, MyLimbType> &result,
                                        const uintwide_t_backend<MyWidth2, MyLimbType> &x) {
    result.representation() /= x.crepresentation();
}
...
template <const ::math::wide_integer::size_t MyWidth2, typename MyLimbType, typename IntegralType,
          typename std::enable_if<
              ((std::is_fundamental<IntegralType>::value == true) && (std::is_integral<IntegralType>::value == true) &&
               (std::is_unsigned<IntegralType>::value == true) &&
               (std::numeric_limits<IntegralType>::digits <= std::numeric_limits<MyLimbType>::digits))>::type const * =
              nullptr>
...
template <const ::math::wide_integer::size_t MyWidth2, typename MyLimbType>
WIDE_INTEGER_CONSTEXPR void eval_modulus(uintwide_t_backend<MyWidth2, MyLimbType> &result,
                                         const uintwide_t_backend<MyWidth2, MyLimbType> &x) {
    result.representation() %= x.crepresentation();
}
...
template <const ::math::wide_integer::size_t MyWidth2, typename MyLimbType, typename IntegralType,
          typename std::enable_if<
              ((std::is_fundamental<IntegralType>::value == true) && (std::is_integral<IntegralType>::value == true) &&
               ...
               (std::numeric_limits<IntegralType>::digits <= std::numeric_limits<MyLimbType>::digits))>::type const * =
              nullptr>
WIDE_INTEGER_CONSTEXPR IntegralType eval_integer_modulus(uintwide_t_backend<MyWidth2, MyLimbType> &x,
...
WIDE_INTEGER_CONSTEXPR IntegralType eval_integer_modulus(uintwide_t_backend<MyWidth2, MyLimbType> &x,
                                                         const IntegralType &n) {
    const uintwide_t_backend<MyWidth2, MyLimbType> rem =
        x.crepresentation() % uintwide_t_backend<MyWidth2, MyLimbType>(n);

    return (IntegralType)rem;
}

template <const ::math::wide_integer::size_t MyWidth2, typename MyLimbType>
WIDE_INTEGER_CONSTEXPR void eval_bitwise_and(uintwide_t_backend<MyWidth2, MyLimbType> &result,
                                             const uintwide_t_backend<MyWidth2, MyLimbType> &x) {
    result.representation() &= x.crepresentation();
}

template <const ::math::wide_integer::size_t MyWidth2, typename MyLimbType>
WIDE_INTEGER_CONSTEXPR void eval_bitwise_or(uintwide_t_backend<MyWidth2, MyLimbType> &result,
                                            const uintwide_t_backend<MyWidth2, MyLimbType> &x) {
    result.representation() |= x.crepresentation();
}

template <const ::math::wide_integer::size_t MyWidth2, typename MyLimbType>
WIDE_INTEGER_CONSTEXPR void eval_bitwise_xor(uintwide_t_backend<MyWidth2, MyLimbType> &result,
                                             const uintwide_t_backend<MyWidth2, MyLimbType> &x) {
    result.representation() ^= x.crepresentation();
}

template <const ::math::wide_integer::size_t MyWidth2, typename MyLimbType>
WIDE_INTEGER_CONSTEXPR void eval_complement(uintwide_t_backend<MyWidth2, MyLimbType> &result,
                                            const uintwide_t_backend<MyWidth2, MyLimbType> &x) {
    for (auto i = 0U;
         i < std::tuple_size<typename uintwide_t_backend<MyWidth2, MyLimbType>::representation_type>::value; ++i) {
...
template <const ::math::wide_integer::size_t MyWidth2, typename MyLimbType>
WIDE_INTEGER_CONSTEXPR void
eval_powm(uintwide_t_backend<MyWidth2, MyLimbType> &result, const uintwide_t_backend<MyWidth2, MyLimbType> &b,
          const uintwide_t_backend<MyWidth2, MyLimbType> &p, const uintwide_t_backend<MyWidth2, MyLimbType> &m) {
    result.representation() = powm(b.crepresentation(), p.crepresentation(), m.crepresentation());
}

template <const ::math::wide_integer::size_t MyWidth2, typename MyLimbType, typename OtherIntegralTypeM,
...
WIDE_INTEGER_CONSTEXPR void eval_powm(uintwide_t_backend<MyWidth2, MyLimbType> &result,
                                      ...
                                      const uintwide_t_backend<MyWidth2, MyLimbType> &p, const OtherIntegralTypeM m) {
    result.representation() = powm(b.crepresentation(), p.crepresentation(), m);
}

template <const ::math::wide_integer::size_t MyWidth2, typename MyLimbType, typename OtherIntegralTypeP,
...
WIDE_INTEGER_CONSTEXPR void eval_powm(uintwide_t_backend<MyWidth2, MyLimbType> &result,
                                      const uintwide_t_backend<MyWidth2, MyLimbType> &b, const OtherIntegralTypeP p,
                                      const uintwide_t_backend<MyWidth2, MyLimbType> &m) {
    result.representation() = powm(b.crepresentation(), p, m.crepresentation());
}
...
template <const ::math::wide_integer::size_t MyWidth2, typename MyLimbType>
WIDE_INTEGER_CONSTEXPR bool eval_eq(const uintwide_t_backend<MyWidth2, MyLimbType> &a,
                                    const uintwide_t_backend<MyWidth2, MyLimbType> &b) {
    return (a.compare(b) == 0);
}

template <const ::math::wide_integer::size_t MyWidth2, typename MyLimbType, typename ArithmeticType,
...
template <const ::math::wide_integer::size_t MyWidth2, typename MyLimbType>
WIDE_INTEGER_CONSTEXPR bool eval_gt(const uintwide_t_backend<MyWidth2, MyLimbType> &a,
                                    const uintwide_t_backend<MyWidth2, MyLimbType> &b) {
...
template <const ::math::wide_integer::size_t MyWidth2, typename MyLimbType>
WIDE_INTEGER_CONSTEXPR bool eval_lt(const uintwide_t_backend<MyWidth2, MyLimbType> &a,
                                    const uintwide_t_backend<MyWidth2, MyLimbType> &b) {
    return (a.compare(b) == -1);
}
...
template <const ::math::wide_integer::size_t MyWidth2, typename MyLimbType>
WIDE_INTEGER_CONSTEXPR void eval_convert_to(long double *result, const uintwide_t_backend<MyWidth2, MyLimbType> &val) {
...
template <const ::math::wide_integer::size_t MyWidth2, typename MyLimbType, typename ThisPolicy,
...
struct precision<boost::multiprecision::number<boost::multiprecision::uintwide_t_backend<MyWidth2, MyLimbType>,
    ...
    using type = typename mpl::if_c<((local_digits_2::value <= precision_type::value) || (precision_type::value <= 0)),
                                    local_digits_2, precision_type>::type;
#else
    using type =
...
class numeric_limits<boost::multiprecision::number<boost::multiprecision::uintwide_t_backend<MyWidth2, MyLimbType>,
  ...
  public:
    ...
    static constexpr int max_exponent =
        std::numeric_limits<::math::wide_integer::uintwide_t<MyWidth2, MyLimbType>>::max_exponent;
    static constexpr int max_exponent10 =
        std::numeric_limits<::math::wide_integer::uintwide_t<MyWidth2, MyLimbType>>::max_exponent10;
    static constexpr int min_exponent =
        std::numeric_limits<::math::wide_integer::uintwide_t<MyWidth2, MyLimbType>>::min_exponent;
    static constexpr int min_exponent10 =
        std::numeric_limits<::math::wide_integer::uintwide_t<MyWidth2, MyLimbType>>::min_exponent10;
    ...
    boost::multiprecision::number<boost::multiprecision::uintwide_t_backend<MyWidth2, MyLimbType>,
                                  ExpressionTemplatesOptions>(min)() {
        return boost::multiprecision::uintwide_t_backend<MyWidth2, MyLimbType>(
            (std::numeric_limits<::math::wide_integer::uintwide_t<MyWidth2, MyLimbType>>::min)());
    }
    static WIDE_INTEGER_CONSTEXPR
    boost::multiprecision::number<boost::multiprecision::uintwide_t_backend<MyWidth2, MyLimbType>,
                                  ExpressionTemplatesOptions>(max)() {
        return boost::multiprecision::uintwide_t_backend<MyWidth2, MyLimbType>(
            (std::numeric_limits<::math::wide_integer::uintwide_t<MyWidth2, MyLimbType>>::max)());
    }
    static WIDE_INTEGER_CONSTEXPR
        boost::multiprecision::number<boost::multiprecision::uintwide_t_backend<MyWidth2, MyLimbType>,
                                      ExpressionTemplatesOptions>
        lowest() {
        return boost::multiprecision::uintwide_t_backend<MyWidth2, MyLimbType>(
            std::numeric_limits<::math::wide_integer::uintwide_t<MyWidth2, MyLimbType>>::lowest);
    }
    static WIDE_INTEGER_CONSTEXPR
        boost::multiprecision::number<boost::multiprecision::uintwide_t_backend<MyWidth2, MyLimbType>,
                                      ExpressionTemplatesOptions>
        epsilon() {
        return boost::multiprecision::uintwide_t_backend<MyWidth2, MyLimbType>(
            std::numeric_limits<::math::wide_integer::uintwide_t<MyWidth2, MyLimbType>>::epsilon);
    }
    static WIDE_INTEGER_CONSTEXPR
        boost::multiprecision::number<boost::multiprecision::uintwide_t_backend<MyWidth2, MyLimbType>,
                                      ExpressionTemplatesOptions>
        round_error() {
        return boost::multiprecision::uintwide_t_backend<MyWidth2, MyLimbType>(
            std::numeric_limits<::math::wide_integer::uintwide_t<MyWidth2, MyLimbType>>::round_error);
    }
    static WIDE_INTEGER_CONSTEXPR
        boost::multiprecision::number<boost::multiprecision::uintwide_t_backend<MyWidth2, MyLimbType>,
                                      ExpressionTemplatesOptions>
        infinity() {
        return boost::multiprecision::uintwide_t_backend<MyWidth2, MyLimbType>(
            std::numeric_limits<::math::wide_integer::uintwide_t<MyWidth2, MyLimbType>>::infinity);
    }
    static WIDE_INTEGER_CONSTEXPR
        boost::multiprecision::number<boost::multiprecision::uintwide_t_backend<MyWidth2, MyLimbType>,
                                      ExpressionTemplatesOptions>
        quiet_NaN() {
        return boost::multiprecision::uintwide_t_backend<MyWidth2, MyLimbType>(
            std::numeric_limits<::math::wide_integer::uintwide_t<MyWidth2, MyLimbType>>::quiet_NaN);
    }
    static WIDE_INTEGER_CONSTEXPR
        boost::multiprecision::number<boost::multiprecision::uintwide_t_backend<MyWidth2, MyLimbType>,
                                      ExpressionTemplatesOptions>
        signaling_NaN() {
        return boost::multiprecision::uintwide_t_backend<MyWidth2, MyLimbType>(
            std::numeric_limits<::math::wide_integer::uintwide_t<MyWidth2, MyLimbType>>::signaling_NaN);
    }
    static WIDE_INTEGER_CONSTEXPR
        boost::multiprecision::number<boost::multiprecision::uintwide_t_backend<MyWidth2, MyLimbType>,
                                      ExpressionTemplatesOptions>
        denorm_min() {
        return boost::multiprecision::uintwide_t_backend<MyWidth2, MyLimbType>(
            std::numeric_limits<::math::wide_integer::uintwide_t<MyWidth2, MyLimbType>>::denorm_min);
    }
};
...
template <const ::math::wide_integer::size_t MyWidth2, typename MyLimbType,
          const boost::multiprecision::expression_template_option ExpressionTemplatesOptions>
constexpr bool std::numeric_limits<boost::multiprecision::number<
    boost::multiprecision::uintwide_t_backend<MyWidth2, MyLimbType>, ExpressionTemplatesOptions>>::is_specialized;
template <const ::math::wide_integer::size_t MyWidth2, typename MyLimbType,
          const boost::multiprecision::expression_template_option ExpressionTemplatesOptions>
constexpr bool std::numeric_limits<boost::multiprecision::number<
    boost::multiprecision::uintwide_t_backend<MyWidth2, MyLimbType>, ExpressionTemplatesOptions>>::is_signed;
template <const ::math::wide_integer::size_t MyWidth2, typename MyLimbType,
          const boost::multiprecision::expression_template_option ExpressionTemplatesOptions>
constexpr bool std::numeric_limits<boost::multiprecision::number<
    boost::multiprecision::uintwide_t_backend<MyWidth2, MyLimbType>, ExpressionTemplatesOptions>>::is_integer;
template <const ::math::wide_integer::size_t MyWidth2, typename MyLimbType,
          const boost::multiprecision::expression_template_option ExpressionTemplatesOptions>
constexpr bool std::numeric_limits<boost::multiprecision::number<
    boost::multiprecision::uintwide_t_backend<MyWidth2, MyLimbType>, ExpressionTemplatesOptions>>::is_exact;
template <const ::math::wide_integer::size_t MyWidth2, typename MyLimbType,
          const boost::multiprecision::expression_template_option ExpressionTemplatesOptions>
constexpr bool std::numeric_limits<boost::multiprecision::number<
    boost::multiprecision::uintwide_t_backend<MyWidth2, MyLimbType>, ExpressionTemplatesOptions>>::is_bounded;
template <const ::math::wide_integer::size_t MyWidth2, typename MyLimbType,
          const boost::multiprecision::expression_template_option ExpressionTemplatesOptions>
constexpr bool std::numeric_limits<boost::multiprecision::number<
    boost::multiprecision::uintwide_t_backend<MyWidth2, MyLimbType>, ExpressionTemplatesOptions>>::is_modulo;
template <const ::math::wide_integer::size_t MyWidth2, typename MyLimbType,
          const boost::multiprecision::expression_template_option ExpressionTemplatesOptions>
constexpr bool std::numeric_limits<boost::multiprecision::number<
    boost::multiprecision::uintwide_t_backend<MyWidth2, MyLimbType>, ExpressionTemplatesOptions>>::is_iec559;
template <const ::math::wide_integer::size_t MyWidth2, typename MyLimbType,
          const boost::multiprecision::expression_template_option ExpressionTemplatesOptions>
constexpr int std::numeric_limits<boost::multiprecision::number<
    boost::multiprecision::uintwide_t_backend<MyWidth2, MyLimbType>, ExpressionTemplatesOptions>>::digits;
template <const ::math::wide_integer::size_t MyWidth2, typename MyLimbType,
          const boost::multiprecision::expression_template_option ExpressionTemplatesOptions>
constexpr int std::numeric_limits<boost::multiprecision::number<
    boost::multiprecision::uintwide_t_backend<MyWidth2, MyLimbType>, ExpressionTemplatesOptions>>::digits10;
template <const ::math::wide_integer::size_t MyWidth2, typename MyLimbType,
          const boost::multiprecision::expression_template_option ExpressionTemplatesOptions>
constexpr int std::numeric_limits<boost::multiprecision::number<
    boost::multiprecision::uintwide_t_backend<MyWidth2, MyLimbType>, ExpressionTemplatesOptions>>::max_digits10;

template <const ::math::wide_integer::size_t MyWidth2, typename MyLimbType,
          const boost::multiprecision::expression_template_option ExpressionTemplatesOptions>
constexpr int std::numeric_limits<boost::multiprecision::number<
    boost::multiprecision::uintwide_t_backend<MyWidth2, MyLimbType>, ExpressionTemplatesOptions>>::max_exponent;
template <const ::math::wide_integer::size_t MyWidth2, typename MyLimbType,
          const boost::multiprecision::expression_template_option ExpressionTemplatesOptions>
constexpr int std::numeric_limits<boost::multiprecision::number<
    boost::multiprecision::uintwide_t_backend<MyWidth2, MyLimbType>, ExpressionTemplatesOptions>>::max_exponent10;
template <const ::math::wide_integer::size_t MyWidth2, typename MyLimbType,
          const boost::multiprecision::expression_template_option ExpressionTemplatesOptions>
constexpr int std::numeric_limits<boost::multiprecision::number<
    boost::multiprecision::uintwide_t_backend<MyWidth2, MyLimbType>, ExpressionTemplatesOptions>>::min_exponent;
template <const ::math::wide_integer::size_t MyWidth2, typename MyLimbType,
          const boost::multiprecision::expression_template_option ExpressionTemplatesOptions>
constexpr int std::numeric_limits<boost::multiprecision::number<
    boost::multiprecision::uintwide_t_backend<MyWidth2, MyLimbType>, ExpressionTemplatesOptions>>::min_exponent10;

template <const ::math::wide_integer::size_t MyWidth2, typename MyLimbType,
          const boost::multiprecision::expression_template_option ExpressionTemplatesOptions>
constexpr int std::numeric_limits<boost::multiprecision::number<
    boost::multiprecision::uintwide_t_backend<MyWidth2, MyLimbType>, ExpressionTemplatesOptions>>::radix;
template <const ::math::wide_integer::size_t MyWidth2, typename MyLimbType,
          const boost::multiprecision::expression_template_option ExpressionTemplatesOptions>
constexpr std::float_round_style std::numeric_limits<boost::multiprecision::number<
    boost::multiprecision::uintwide_t_backend<MyWidth2, MyLimbType>, ExpressionTemplatesOptions>>::round_style;
template <const ::math::wide_integer::size_t MyWidth2, typename MyLimbType,
          const boost::multiprecision::expression_template_option ExpressionTemplatesOptions>
constexpr bool std::numeric_limits<boost::multiprecision::number<
    boost::multiprecision::uintwide_t_backend<MyWidth2, MyLimbType>, ExpressionTemplatesOptions>>::has_infinity;
template <const ::math::wide_integer::size_t MyWidth2, typename MyLimbType,
          const boost::multiprecision::expression_template_option ExpressionTemplatesOptions>
constexpr bool std::numeric_limits<boost::multiprecision::number<
    boost::multiprecision::uintwide_t_backend<MyWidth2, MyLimbType>, ExpressionTemplatesOptions>>::has_quiet_NaN;
template <const ::math::wide_integer::size_t MyWidth2, typename MyLimbType,
          const boost::multiprecision::expression_template_option ExpressionTemplatesOptions>
constexpr bool std::numeric_limits<boost::multiprecision::number<
    boost::multiprecision::uintwide_t_backend<MyWidth2, MyLimbType>, ExpressionTemplatesOptions>>::has_signaling_NaN;
template <const ::math::wide_integer::size_t MyWidth2, typename MyLimbType,
          const boost::multiprecision::expression_template_option ExpressionTemplatesOptions>
constexpr std::float_denorm_style std::numeric_limits<boost::multiprecision::number<
    boost::multiprecision::uintwide_t_backend<MyWidth2, MyLimbType>, ExpressionTemplatesOptions>>::has_denorm;
template <const ::math::wide_integer::size_t MyWidth2, typename MyLimbType,
          const boost::multiprecision::expression_template_option ExpressionTemplatesOptions>
constexpr bool std::numeric_limits<boost::multiprecision::number<
    boost::multiprecision::uintwide_t_backend<MyWidth2, MyLimbType>, ExpressionTemplatesOptions>>::has_denorm_loss;
template <const ::math::wide_integer::size_t MyWidth2, typename MyLimbType,
          const boost::multiprecision::expression_template_option ExpressionTemplatesOptions>
constexpr bool std::numeric_limits<boost::multiprecision::number<
    boost::multiprecision::uintwide_t_backend<MyWidth2, MyLimbType>, ExpressionTemplatesOptions>>::traps;
template <const ::math::wide_integer::size_t MyWidth2, typename MyLimbType,
          const boost::multiprecision::expression_template_option ExpressionTemplatesOptions>
constexpr bool std::numeric_limits<boost::multiprecision::number<
    boost::multiprecision::uintwide_t_backend<MyWidth2, MyLimbType>, ExpressionTemplatesOptions>>::tinyness_before;
