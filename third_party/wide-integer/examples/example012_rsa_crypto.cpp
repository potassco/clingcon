...
namespace local_rsa {
template <const std::size_t RsaBitCount, typename LimbType = std::uint32_t,
...
class rsa_base {
  public:
    ...
    using my_uintwide_t =
        ::math::wide_integer::uintwide_t<::math::wide_integer::size_t(bit_count), LimbType, allocator_type>;
    ...
    struct euclidean {
        ...
        static IntegerType extended_euclidean(const IntegerType &a, const IntegerType &b, IntegerType *x,
                                              IntegerType *y) {
    ...
    class encryptor {
      public:
        ...
        void encrypt(InputIterator in_first, const std::size_t count, OutputIterator out) {
            for (auto it = in_first;
                 it != in_first + typename std::iterator_traits<InputIterator>::difference_type(count); ++it) {
    ...
    rsa_base(const rsa_base &other)
        : my_p(other.my_p), my_q(other.my_q), my_r(other.my_r), my_m(other.my_m), phi_of_m(other.phi_of_m),
          public_key(other.public_key), private_key(other.private_key) {}

    rsa_base(rsa_base &&other)
        : my_p((my_uintwide_t &&)other.my_p), my_q((my_uintwide_t &&)other.my_q), my_r((my_uintwide_t &&)other.my_r),
          my_m((my_uintwide_t &&)other.my_m), phi_of_m((my_uintwide_t &&)other.phi_of_m),
          public_key((public_key_type &&)other.public_key), private_key((private_key_type &&)other.private_key) {}
    ...
    static bool is_prime(const my_uintwide_t &p,
                         const RandomEngineType &generator =
                             RandomEngineType(static_cast<typename RandomEngineType::result_type>(std::clock()))) {
  ...
  protected:
    ...
    rsa_base(const my_uintwide_t &p_in, const my_uintwide_t &q_in, const my_uintwide_t &r_in)
        : my_p(p_in), my_q(q_in), my_r(r_in), my_m(my_p * my_q), phi_of_m(), public_key(), private_key() {
...
class rsa_fips : public rsa_base<RsaBitCount, LimbType> {
  ...
  public:
    rsa_fips(const typename base_class_type::my_uintwide_t &p_in, const typename base_class_type::my_uintwide_t &q_in,
        ...
        base_class_type::phi_of_m = lcm(base_class_type::my_p - my_one, base_class_type::my_q - my_one);
...
class rsa_traditional : public rsa_base<RsaBitCount, LimbType> {
  ...
  public:
    rsa_traditional(const typename base_class_type::my_uintwide_t &p_in,
        ...
        base_class_type::phi_of_m = ((base_class_type::my_p - my_one) * (base_class_type::my_q - my_one));
...
bool math::wide_integer::example012_rsa_crypto() {
    ...
    const rsa_integral_type p("0xFF03B1A74827C746DB83D2EAFF00067622F545B62584321256E62B01509F10962F9C5C8FD0B7F5184A9CE8"
                              "E81F439DF47DDA14563DD55A221799D2AA57ED2713271678A5A0B8B40A84AD13D5B6E6599E6467C670109CF1"
                              "F45CCFED8F75EA3B814548AB294626FE4D14FF764DD8B091F11A0943A2DD2B983B0DF02F4C4D00B413");
    const rsa_integral_type q("0xDACAABC1DC57FAA9FD6A4274C4D588765A1D3311C22E57D8101431B07EB3DDCB05D77D9A742AC2322FE6A0"
                              "63BD1E05ACB13B0FE91C70115C2B1EEE1155E072527011A5F849DE7072A1CE8E6B71DB525FBCDA7A89AAED46"
                              "D27ACA5EAEAF35A26270A4A833C5CDA681FFD49BAA0F610BAD100CDF47CC86E5034E2A0B2179E04EC7");
    const rsa_integral_type e("0x100000001");
    const rsa_integral_type n(
        "0xD9F3094B36634C05A02AE1A5569035107A48029E39B3C6A1853817F063E18E761C0C538E55FF2C7E53D603BB35CABB3B8D07F82AA0AF"
        "DEAF7441FCF6746C5BCAAA2CDE398AD73EDB9C340C3FFCA559132581EAF8F65C13D02F3445A932A3E1FADB5912F7553EDEC5047E4D0ED0"
        "6EE87EFFC549E194D38E06B73A971C961688BA2D4AA4F450D2523372F317D41D06F9F0360E962CE953A69F36C53C370799FCFBA195E8F6"
        "91EBE862F84AE4BBD7747BC14499BD0EFFFCDC7154325908355C2FFC5B3948B8102B33AA2420381470E4EE858380FF0EEA58288516C263"
        "F6D51DBBD0E477D1393A0A3EE60E1FDE4330856665BF522006608A6104C138C0F39E09C4C5");
    const rsa_integral_type d(
        "0x1BF009CADDC664B4404D59711FDE16D7C55822449DE1C5A084D22ED5791FDAA37EA538867FC91A17E6856E277C2DEDD70CA8BF6EC44B"
        "0E729917A88E5988CC561D948DDEEA46E21FD8FF46CCE7657C94BFB1BDF40B3B30D4595A8BC3A15F1D4AD4C665C09B3B265BA19CDB0B89"
        "CBAADD0097FF52E9F6E594F86829C5BB4E9BA0200F12FA6DC60FD28DEC0D194F08DEB50F5A7749540160D6E8338E75B11165B76F4650C2"
        "FCCE08F979AD9941DAEDAA5E328473BF712F8F549C36967F5E15477DC643D1F48D563139134E5CDC4BB84F9782CD5125E864E067CB9802"
        "90F215CB41090E297BAC2714EFBA61115D85613851C2DE50A82F4AB526B88C61B7C9A0B589");
    ...
    result_is_ok &= ((rsa.get_p() == p) && (rsa.get_q() == q) && (rsa.get_d() == d));
