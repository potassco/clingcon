...
TEMPLATE_TEST_CASE(
    "uniform_floating_point_distribution never returns infs from finite range",
...
TEST_CASE( "uniform_integer_distribution can return the bounds",
           "[rng][distribution]" ) {
...
TEMPLATE_TEST_CASE( "uniform_integer_distribution is reproducible",
    ...
    REQUIRE_THAT( generated,
                  Catch::Matchers::RangeEquals(
                      uniform_integer_test_params<TestType>::expected ) );
}
...
TEMPLATE_TEST_CASE( "uniform_floating_point_distribution is reproducible",
    ...
    Catch::uniform_floating_point_distribution<TestType> dist( lowest,
                                                               highest );
    ...
    REQUIRE_THAT( generated,
                  Catch::Matchers::RangeEquals(
                      uniform_fp_test_params<TestType>::expected ) );
}

#endif // ^^ float reproducibility tests are enabled

TEMPLATE_TEST_CASE(
    "uniform_floating_point_distribution can handle unitary ranges",
    "[rng][distribution][floating-point][approvals]",
    float,
    double ) {
    std::random_device rd;
