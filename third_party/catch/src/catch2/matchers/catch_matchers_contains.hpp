...
namespace Catch {
    namespace Matchers {
        //! Matcher for checking that an element in range is equal to specific
        //! element
        ...
        //! Meta-matcher for checking that an element in a range matches a
        //! specific matcher
        ...
        /**
         * Creates a matcher that checks whether a range contains a specific
         * element.
         *
        ...
        //! Creates a matcher that checks whether a range contains element
        //! matching a matcher
        template <typename Matcher>
