...
namespace {
    ...
    void
    print( std::ostream& os, int const level, Catch::MessageInfo const& info ) {
    ...
    void print( std::ostream& os,
        ...
        os << ws( level + 1 ) << "- properties (flags): 0x" << std::hex
           << static_cast<uint32_t>( info.properties ) << std::dec << "\n";
    }
    ...
    struct MyListener : Catch::EventListenerBase {
        ...
        void assertionStarting(
            Catch::AssertionInfo const& assertionInfo ) override {
...
// Compile & run:
// - g++ -std=c++14 -Wall -I$(CATCH_SINGLE_INCLUDE) -o 210-Evt-EventListeners
// 210-Evt-EventListeners.cpp && 210-Evt-EventListeners --success
// - cl -EHsc -I%CATCH_SINGLE_INCLUDE% 210-Evt-EventListeners.cpp &&
// 210-Evt-EventListeners --success
