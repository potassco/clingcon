...
bool math::wide_integer::example008a_miller_rabin_prime() {
    using wide_integer_type =
        boost::multiprecision::number<boost::multiprecision::uintwide_t_backend<512U>, boost::multiprecision::et_off>;

    boost::random::mt11213b base_gen(static_cast<typename boost::random::mt11213b::result_type>(std::clock()));

    boost::random::independent_bits_engine<boost::random::mt11213b, std::numeric_limits<wide_integer_type>::digits,
                                           wide_integer_type>
        gen(base_gen);
