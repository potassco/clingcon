...
namespace Catch {
    namespace Matchers {
        ...
        namespace Detail {
            ...
            std::string describe_multi_matcher(
                ...
                std::array<std::string, sizeof...( MatcherTs )> descriptions{
                    { static_cast<MatcherTs const*>( matchers[Idx] )
                          ->toString()... } };
            ...
            public:
                ...
                MatchAllOfGeneric&
                operator=( MatchAllOfGeneric const& ) = delete;
                ...
                friend std::enable_if_t<
                    is_matcher<MatcherLHS>::value,
                    MatchAllOfGeneric<MatcherLHS, MatcherTs...>>
                operator&&( MatcherLHS const& lhs,
            ...
            public:
                ...
                MatchAnyOfGeneric&
                operator=( MatchAnyOfGeneric const& ) = delete;
            ...
            public:
                ...
                MatchNotOfGeneric&
                operator=( MatchNotOfGeneric const& ) = delete;
                ...
                //! Negating negation can just unwrap and return underlying
                //! matcher
        ...
        std::enable_if_t<
            Detail::are_generic_matchers<MatcherLHS, MatcherRHS>::value,
        ...
        std::enable_if_t<
            Detail::is_generic_matcher<MatcherLHS>::value,
        ...
        std::enable_if_t<
            Detail::is_generic_matcher<MatcherRHS>::value,
