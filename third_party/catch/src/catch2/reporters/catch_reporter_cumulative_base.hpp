...
namespace Catch {
    ...
    namespace Detail {
        ...
        //! Represents either an assertion or a benchmark result to be handled
        //! by cumulative reporter later
    ...
    public:
        ...
        //! Customization point: called after last test finishes (testRunEnded
        //! has been handled)
    ...
    protected:
        //! Should the cumulative base store the assertion expansion for
