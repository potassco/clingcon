...
namespace Catch {
    namespace Matchers {
        ...
        //! Creates a matcher that matches vectors that contain `comparator` as
        //! an element
        ...
        //! Creates a matcher that matches vectors that `comparator` as an
        //! element
        template <typename T,
                  typename AllocComp = std::allocator<T>,
                  typename AllocMatch = AllocComp>
        ...
        //! Creates a matcher that matches vectors that is equal to `target`
        //! modulo permutation
        template <typename T,
                  typename AllocComp = std::allocator<T>,
                  typename AllocMatch = AllocComp>
