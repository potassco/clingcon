...
/**\file
 * Registers an event listener to increments counter of assertionStarting
 * events.
 *
...
namespace {
    ...
    static bool f1() { return assertion_starting_events_seen == 1; }
...
TEST_CASE() {
    ...
    REQUIRE_THROWS( f3() );
    REQUIRE_THAT(
        f4(), Catch::Matchers::Predicate<bool>( []( bool b ) { return b; } ) );
